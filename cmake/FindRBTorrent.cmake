...
IF (RBTorrent_INCLUDE_DIR)
	IF (WIN32)
		SET (PROBE_DIR_Debug ${RBTorrent_DIR}/bin/msvc-10.0/debug/asserts-production/boost-link-shared/boost-source/encryption-off/threading-multi/)
		SET (PROBE_DIR_Release ${RBTorrent_DIR}/bin/msvc-10.0/release/asserts-production/boost-link-shared/boost-source/encryption-off/threading-multi/)
